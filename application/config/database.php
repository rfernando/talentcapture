...
/**
 * We are Going to use Laravel's Eloquent ORM for this Project
 * To view the complete documentation of Laravel's Eloquent ORM follow the link :
 * https://laravel.com/docs/4.2/eloquent 
 *
 * Connection to Eloquent's ORM
 */

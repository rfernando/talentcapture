...
class Model {
	...
	protected function  lists($columnName = NULL){
		$results = $this->all();
		$returnArray[''] = 'Select '.get_called_class();
		foreach ($results as $result)
			$returnArray[$result->{$this->primary}] = !is_null($columnName) ? $result->$columnName : $result;
		return $returnArray;
	}
	...
	private function setData($field, $value = null)
	{

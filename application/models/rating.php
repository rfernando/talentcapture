...
class Rating extends Eloquent{
     ...
     */
    protected $fillable = [
        'title', 'industry_id','profession_id', 'notify_preferred', 'skills','job_location', 'position_type', 'client_name','client_name_confidential','salary','payment_terms', 'warranty_period','placement_fee','split_percentage', 'note', 'description','user_id','visa_sponsorship','relocate'];

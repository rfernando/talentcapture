...
@section('main-content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ admin_url('blogs') }}"><i class="fa fa-rss"></i> Blog</a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <!-- /.mail-box-messages -->
                        <form action="{{ base_url('admin/blogs/update/'.$blog->id) }}" method="post" class="form-horizontal validateForm">
                            {{ flash_msg() }}
                            {{ generate_form_fields($blogFields, 3) }}

...
@section('main-content')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="fa fa-pencil"></i> Update Industry</h4>
                </div>
                <div class="modal-body">
                    <form role="form" action="{{ admin_url('job_categories/edit?v=industry') }}" id="edit-form" method="POST">
                        <div class="box-body">
                            <div class="form-group">
                                <label>Industry</label>
                                <input class="form-control input-lg" id="edit-title" name="title" onblur="validate_form()" placeholder="Enter Industry Name" autocomplete="off" type="text">
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <section class="content-header">
        <h1>
            Job Categories
            <small>List of Industries</small>
        </h1>
        <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-xs-8">
                <div class="box box-warning">
                    <div class="box-header">
                        <h3 class="box-title"><i class="fa fa-sitemap"></i> List of Industries</h3>
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            @foreach($industry as $category)
                                <tr>
                                    ...
                                    <td>
                                        @if(!$category->trashed())
                                            <button data-url="{{ admin_url('job_categories/edit/'.$category->id.'?v=industry')}}" class="btn btn-info edit-category" data-toggle="modal" data-target="#edit-category-modal"><i class="fa fa-pencil"></i></button>
                                            <a href="{{ admin_url('job_categories/delete/'.$category->id.'?v=industry')}}" class="btn btn-danger" onclick="return confirm('Do you really want to delete this Job category ?')"><i class="fa fa-trash"></i></a>
                                        @else
                                            <a href="{{ admin_url('job_categories/restore/'.$category->id.'?v=industry')}}" class="btn btn-success" onclick="return confirm('Do you really want to Restore this Job category ?')"><i class="fa fa-recycle"></i></a>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
            ...
            <div class="col-xs-4">
                <div class="box box-danger">
                    <div class="box-header">
                        <h3 class="box-title"><i class="fa fa-plus-circle"></i>  New Industry</h3>
                    </div>
                    <form role="form" action="{{ admin_url('job_categories/add?v=industry') }}" method="POST" onsubmit="return validate_form()">
                        <div class="box-body">
                            <div class="form-group">
                                <label>Industry</label>
                                <input class="form-control input-lg" id="title" name="industry[title]" onblur="validate_form()" placeholder="Industry Name" autocomplete="off" type="text">
                            </div>
                        </div>
                        <!-- /.box-body -->

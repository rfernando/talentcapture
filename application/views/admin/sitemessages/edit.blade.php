...
@section('main-content')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ admin_url('email') }}"><i class="fa fa-envelope"></i> Message Templates</a></li>
            <li class="active">Edit Message Template</li>
        </ol>
    </section>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <!-- /.mail-box-messages -->
                        <form action="{{ base_url('admin/message/update/'.$template->id) }}" method="post" class="form-horizontal validateForm">
                            {{ flash_msg() }}
                            {{ generate_form_fields($messageFields,2) }}

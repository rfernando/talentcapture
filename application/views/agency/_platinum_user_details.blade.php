    ...
    <div class="box-footer">
        <div class="row">
            ...
            <div class="col-xs-6"  style="padding-left: 120px">
                <span>
                    <a href="{{$user->user_profile->linkedin_url}}" target="_blank"><i class="fa fa-linkedin-square fa-2x margin-r-10"></i></a>
                </span>

                    @if($user->user_profile->facebook_url != '')
                        <span>
                            <a href="{{$user->user_profile->facebook_url}}" target="_blank"><i class="fa fa-facebook-square fa-2x margin-r-10"></i></a>
                        </span>
                    @endif

                    @if($user->user_profile->twitter_url != '')
                        <span>
                            <a href="{{$user->user_profile->twitter_url}}" target="_blank"><i class="fa fa-twitter-square fa-2x margin-r-10"></i></a>
                        </span>
                    @endif
            </div>
        </div>
       ...
       <!--  Phone, Industries and Professions Display--> 
        <div class="row">
        @unless(!$user->phone)
            <div class="col-xs-12">

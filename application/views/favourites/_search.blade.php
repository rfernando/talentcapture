   ...
   <form action="">
    <div class="input-group">
        <input type="text" class="form-control input-lg search-input" autocomplete="off" id="search-agency" placeholder="Use Boolean to search for recruiting agencies">
        <span class="input-group-btn">
            <button type="submit" name="search" id="search-btn" class="btn btn-primary btn-lg"><i class="fa fa-search"></i></button>
        </span>
    </div>
</form>
        ...
        $(document).ready(function () {
            ...
            $('#search-agency').on('keyup', function () {
                ...
                if(searchTxt.length > 0){
                    $.ajax({
                        url: '{{ base_url('agency/search').'/' }}' + searchTxt,
                        dataType : 'html',

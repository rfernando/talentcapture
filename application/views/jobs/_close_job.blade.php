                        ...
                        <div class="form-group">
                            <div class="radio">
                                ...
                                <!-- 
                                 ...
                                 -->
                                    <input type="radio" name="candidate-hired" id="no-candidate-hired" value="0" {{ (count($candidates_list)<1) ? 'checked':''}}>
                                     &nbsp;&nbsp;I did not hire a candidate through the TalentCapture Platform
                                </label>
                            </div>
                            <div class="radio">
                                <label>
                                ...
                                -->
                                    <input type="radio" name="candidate-hired" id="candidates-hired" value="0" title="No candidates on this Job" {{ (count($candidates_list)>1) ? 'checked':''}} >
                                    &nbsp;&nbsp;The following candidates were successfully hired. 
                                </label>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <div class="info-box">
                                            ...
                                            <div class="info-box-content">
                                                <span class="info-box-text" style="text-transform:  capitalize;">
                                                    <span style="font-weight: 600;">{{ $agency->first_name.' '.$agency->last_name }}</span>
                                                    <br>
                                                    <span>{{ $agency->user_profile->company_name }}</span>
...
@section('end-script')
    ...
    <script type="application/javascript">
        ...
        function loadhiredcandidatedetails(elem)
        {
            var html  = '';
            var data = [];
            if(elem) {
        ...
        data = $(hiredCandidates);
            ...
            data.each(function (key, candidate) {
        ...
        body.on('select2:select','.select2', function (evt) {
            loadhiredcandidatedetails($(this));
        });

        body.on('change','.select2', function (evt) {
            loadhiredcandidatedetails($(this));
        });
